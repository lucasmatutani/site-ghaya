...
<body>
    <form action="cadastro_sql.php" method="POST" id="form_cadastro" enctype="multipart/form-data">
        <input type="hidden" id="listingId" value="<?php echo $imovelId ?>">
        <div class="residencial">
            ...
            <div class="row mb-2" style="margin-bottom: 30px !important;">
                <div class="col-2">
                    <p>Mostrar imóvel na pagina inicial?</p>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="imovel_destaque" id="destaque_sim" value="1" required>
                        <label class="form-check-label" for="destaque_sim">Sim</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="imovel_destaque" id="destaque_nao" value="0" required checked>
                ...
                <div class="col-2">
                    <p>Anunciar no Zap ?</p>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="zap" id="sim" value="1" required>
                        <label class="form-check-label" for="sim">Sim</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="zap" id="nao" value="0" required checked>
